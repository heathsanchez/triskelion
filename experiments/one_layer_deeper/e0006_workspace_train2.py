"""E0006: E0005 workspace representation, but expose the tied workspace transition to its own output during training.

Train: two tied workspace updates.
Eval: four tied workspace updates.
Everything else is held fixed from E0005.
"""
...
class Model(nn.Module):
    ...
    def forward(self, input_ids: Tensor, attention_mask: Tensor | None = None) -> tuple[Tensor, None]:
        ...
        steps = TRAIN_WORKSPACE_STEPS if self.training else EVAL_WORKSPACE_STEPS
