"""Frozen official One Layer Deeper baseline (copied from upstream)."""
...
class Model(nn.Module):
    def __init__(self,spec:ModelSpec)->None:
        ...
        self.token_embedding=nn.Embedding(spec.vocab_size,D_MODEL); self.position_embedding=nn.Embedding(spec.max_seq_len,D_MODEL)
        self.block=Block(); self.final_norm=RMSNorm(D_MODEL); self.head=nn.Linear(D_MODEL,spec.vocab_size,bias=False); self.head.weight=self.token_embedding.weight
