...
R = {
    ...
    'compression': {'warm_retained_governed_cost': warm_retained,'cold_reconstruct_governed_cost': cold_reconstruct,'warm_vs_cold_ratio': warm_retained / cold_reconstruct,'lut_dispatcher_bits': lut_dispatcher},
    'search': {'cold_semantic_state_expansions': cold_search_states,'warm_semantic_state_expansions': warm_search_states,'compression_factor': cold_search_states / warm_search_states},
}
R['gates'] = {
